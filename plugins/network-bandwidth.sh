...
UAABYlAUlSJPAAAAAHdElNRQflCRYSBhnfrDL7AAAF/0lEQVRIx82Va3CUVx3Gf/vumpALpIBpiuBUb
...
tMDktMjJUMTg6MDY6MjUrMDA6MDBMZEDNAAAAJXRFWHRkYXRlOm1vZGlmeQAyMDIxLTA5LTIyVDE4Oj
A2OjI1KzAwOjAwPTn4cQAAABl0RVh0U29mdHdhcmUAd3d3Lmlua3NjYXBlLm9yZ5vuPBoAAAAASUVOR
K5CYII=
EOF
)
...
output_bandwidth() {
    ...
    add_line "${ul_speed// /·} :arrow.up.arrow.down: ${dl_speed// /·}" \
        "image=${ICON_GAUGE}" \
        "font=Menlo"
}
